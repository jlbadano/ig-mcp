"""
Instagram Graph API client for MCP server.
"""
...
class InstagramClient:
    ...
    async def get_profile_info(self, account_id: Optional[str] = None) -> InstagramProfile:
    ...
    async def get_media_insights(
        ...
        try:
            ...
            logger.error("Failed to get media insights", error=str(e), media_id=media_id)
